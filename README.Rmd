...
The goal of ausPH is to retrieve data from the [Parliamentary Library's Handbook website](https://handbook.aph.gov.au/). The first example is a call to produce a list of elections in the Australian Parliament since Federation. 
